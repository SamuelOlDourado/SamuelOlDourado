...
<p align="center">
  Desenvolvedor focado em criar aplicações web, explorar novas tecnologias
...
Sou desenvolvedor com foco em **desenvolvimento web**, trabalhando principalmente com tecnologias de frontend e backend.

Atualmente curso **Engenharia de Software** e busco evoluir constantemente através de estudos, projetos pessoais e experiências práticas.

Gosto de transformar ideias em aplicações funcionais, explorar novas tecnologias e desenvolver projetos que possam fazer parte de um portfólio real.
...
Cada projeto possui descrição com informações, tecnologias utilizadas e instruções quando necessário.

Você pode conferir olhando os **repositórios que fixei** aqui no perfil, ou indo direto para o **meu portifólio** se assim prefirir!

<p align="center">
  <a href="https://samueld-portfolio-oficial.vercel.app/" target="_blank">
    <img
      src="https://img.shields.io/badge/🚀%20Ver%20meu%20portfólio-111111?style=for-the-badge"
      alt="Ver meu portfólio"
    >
  </a>
</p>
...
- 🤖 Explorando APIs e integrações com inteligência artificial
- 🚀 Criando e aprimorando projetos para meu portfólio

---

## 🎯 Objetivo

Continuar evoluindo como desenvolvedor, transformar ideias em aplicações funcionais e construir projetos cada vez mais completos.
